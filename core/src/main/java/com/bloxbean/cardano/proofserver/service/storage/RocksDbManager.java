package com.bloxbean.cardano.proofserver.service.storage;
...
public class RocksDbManager {
    ...
    public RocksDbManager(TrieServerProperties properties) {
    ...
    public void initialize() {
        try {
            ...
            throw new TrieOperationException("Failed to initialize RocksDB", e);
        }
    }
    ...
    private ColumnFamilyOptions createColumnFamilyOptions() {
        TrieServerProperties.StorageProperties storage = properties.getStorage();
    ...
    public synchronized ColumnFamilyHandle getOrCreateColumnFamily(String identifier) {
        ...
        try {
            ...
            throw new TrieOperationException(
    ...
    public void flush() {
        try {
            ...
            throw new TrieOperationException("Failed to flush RocksDB", e);
        }
    }
